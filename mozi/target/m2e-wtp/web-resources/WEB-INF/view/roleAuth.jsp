	...
	<div class="row-fluid">
		<div class="span12" style="margin-top:10px">
			<ul class="breadcrumb">
				...
				<li><a href="javascript:return;">角色管理</a></i></li>
...
function searchList() {
	...
	function addrolemenu() {
			...
			for (var i = 0; i < meus.length; i++) {
				var meu = meus[i];
				html += "<option value='"+meu.id +"'>" + meu.authName
						+ "</option>";
			}
		...
		sendAjaxMeth("roleAnth/selectgetmeunroles", null, _init, null)
	}
	...
	var addmenurole = function() {
				...
				var _init = function(data) {
					if (data.code == 200) {
						...
						Refresh("roleAnth/list");
					}
					}
					sendAjaxMeth("roleAnth/addmenurole", data, _init, null);
				}
		...
		var date = {
			...
			sendAjaxMeth("roleAnth/deleterolemun", date, _init, null);
