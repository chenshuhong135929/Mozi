...
public interface RedisClientTemplate {
    ...
    public abstract <T> String setObject(String key,T t);
    
    public abstract <T> String setExpireObject(String key,int seconds, T t);
    ...
    public abstract <T> T getObject(String key,Class clazz);
