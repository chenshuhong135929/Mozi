...
public class SocketClient {
    public void send(final String host ,final Integer port) throws InterruptedException{
        ...
        //netty channel池   chamel是一个通道 定义通过它可以运输数据
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        try {
                        	//获取一个通道
                            channel = nettyChannelPool.syncGetChannel(host,port);
