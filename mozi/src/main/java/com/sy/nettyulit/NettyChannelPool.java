...
public class NettyChannelPool {
	 private Channel[] channels;
	     ...
	     * 同步获取netty channel
	     */
	    public Channel syncGetChannel(String host ,int 	port ) throws InterruptedException {
	        ...
	        synchronized (locks[index]) {
	            ...
	            //开始跟服务端交互，获取channel
	            channel = connectToServer( host , 	port );
	    ...
	    private Channel connectToServer(String host ,int 	port ) throws InterruptedException {
